        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        <x-nav-link :href="route('userpage', ['user_name' => Auth::user()->name])" :active="request()->routeIs('userpage', ['user_name' => Auth::user()->name])">
                            <div class="text-base text-white">
                                {{ __('MyPage') }}
                            </div>
                        </x-nav-link>
                        ...
                        <div
                            class = "inline-flex items-center px-5 text-sm font-medium text-white mr-0 text-nowrap overflow-hidden">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            <x-slot name="content">
                                @auth
                                    <x-dropdown-link :href="route('userpage', ['user_name' => Auth::user()->name])">
                                        {{ __('マイページ') }}
                                    </x-dropdown-link>
